...
abstract class FormFragment : Fragment(), TextView.OnEditorActionListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
         ...
         * */
        View.inflate(activity, getLayoutResourceID(), viewContainer.findViewById(R.id.fl_form))
    ...
    fun callPasswordDialog() {
        ...
        dialog.setOnShowListener(object : DialogInterface.OnShowListener {
            override fun onShow(d: DialogInterface?) {
                 ...
                 * */
                dialog.getButton(AlertDialog.BUTTON_POSITIVE).setTextColor(ColorUtils.getColor(R.color.colorText))
                dialog.getButton(AlertDialog.BUTTON_NEGATIVE).setTextColor(ColorUtils.getColor(R.color.colorText))

                val etPassword = dialog.findViewById<EditText>(R.id.et_password)!!
                etPassword.validate({ it.isValidPassword() }, getString(R.string.invalid_password))
