...
class ConfigDeliveryAddressHostFragment : Fragment() {
    ...
    override fun onCreateView(
         ...
         * os fragmentos.
         * */
        val view = inflater.inflate(R.layout.fragment_config_delivery_address_host, container, false)
        ...
        if (savedInstanceState == null) {
             ...
             * de fragmentos.
             * */
            transaction.replace(R.id.fl_root, ConfigDeliveryAddressesListFragment()).commit()
        }
