...
import br.com.ejlsistemas.curso.blueshoes.domain.DeliveryAddress
...
class ConfigUpdateDeliveryAddressFragment : ConfigNewDeliveryAddressFragment() {
    ...
    private fun fillForm() {
        val address = arguments!!.getParcelable<DeliveryAddress>(DeliveryAddress.KEY)
    ...
    override fun backEndFakeDelay() {
        backEndFakeDelay(false, getString(R.string.invalid_delivery_address))
    }
