...
class ContactFragment: Fragment(), View.OnClickListener {
    ...
    private fun mailToIntent(emailAddress: String) {
        ...
        try {
            ...
            Toast.makeText(activity, getString(R.string.info_email_app_install), Toast.LENGTH_LONG).show()
        }
    }
    ...
    private fun mapsRouteIntent(address: String) {
        ...
        if(intent.resolveActivity(activity!!.packageManager) != null) {
            ...
            Toast.makeText(activity, getString(R.string.info_google_maps_install), Toast.LENGTH_LONG).show()
        }
    }
