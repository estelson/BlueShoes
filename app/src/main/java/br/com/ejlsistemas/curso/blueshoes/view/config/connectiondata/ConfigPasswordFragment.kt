...
class ConfigPasswordFragment: FormFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        et_new_password.validate({ it.isValidPassword() }, getString(R.string.invalid_password))
        ...
        et_new_password_confirm.validate({
             ...
             * */
            (et_new_password.text.isNotEmpty() && it.equals(et_new_password.text.toString())) || et_new_password.text.isEmpty()
